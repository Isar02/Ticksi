    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrganizerCompanies", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<int>(type: "int", nullable: false),
                    OrganizerCompanyId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Events_OrganizerCompanies_OrganizerCompanyId",
                        column: x => x.OrganizerCompanyId,
                        principalTable: "OrganizerCompanies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Events_OrganizerCompanyId",
                table: "Events",
                column: "OrganizerCompanyId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrganizerCompanies_PublicId",
                table: "OrganizerCompanies",
                column: "PublicId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PromoCodes_PublicId",
                table: "PromoCodes",
                column: "PublicId",
                unique: true);
